...
func (s *serverArgs) ThriftMethodName(methodName string) string {
...
func (handler *{{$receiver}}) {{$.ThriftMethodName $f.Name -}}(ctx context.Context, req *{{$prefix}}.{{$service}}_{{$f.Name}}_Request) (*{{$prefix}}.{{$service}}_{{$f.Name}}_Response, error) {
