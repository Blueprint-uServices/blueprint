...
//
// Once the application is instrumented with these plugins, traces will be generated and collected by the xtrace-server. Traces will consist of xtrace events generated by plugins 1 and 2.
//
// # Artifacts Generated
//
