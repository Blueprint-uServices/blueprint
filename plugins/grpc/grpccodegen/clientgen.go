...
var clientHeader = `// Blueprint: Auto-generated by GRPC Plugin
...
func (client *clientArgs) GenerateCode(outputFilePath string) error {
	...
	body, err := gogen.ExecuteTemplate("GRPCClientBody", clientBody, client)
	if err != nil {
		return err
	}

	header, err := gogen.ExecuteTemplate("GRPCClientHeader", clientHeader, client)
	if err != nil {
		return err
	}
