...
var Fanin = cmdbuilder.SpecOption{
	Name:        "fanin",
	Description: "Fanin topology: Search and Profile both call Geo (other dependencies are dummies)",
	Build:       makeFaninSpec,
}

func makeFaninSpec(spec wiring.WiringSpec) ([]string, error) {
	var cntrs []string
	...
	// Profile Service (also depends on Geo)
