...
var Fanout = cmdbuilder.SpecOption{
	Name:        "fanout",
	Description: "Fanout topology: Frontend calls Search and Profile in parallel (other dependencies are dummies)",
	Build:       makeFanoutSpec,
}

func makeFanoutSpec(spec wiring.WiringSpec) ([]string, error) {
	var cntrs []string
	...
	// Search Service (depends on geo_service and rate_service)
	...
	// Reservation Service (independent)
	...
	// Frontend Service (star topology: all backends in parallel)
